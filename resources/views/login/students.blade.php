...
<div id="login-logo-div">
    <table>
        <tr>
            <td>
            <center>
            <img  class="logo-img" src="{{asset('imgs/user-1.png')}}" />
            </center>
        </td>
        ...
        <td>
            ...
            <form  style="max-width:500px;margin:auto" action="{{url('users/students/login')}}" method="post">
            {{ csrf_field() }}
            ...
            <button type="submit"   name="user-login-btn" class="log-in-btn">Students Log In</button>
            <br>
